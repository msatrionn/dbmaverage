                        ...
                        <li>
                            <a class="profile-pic" href="#">
                                <img src=<?= base_url("assets/plugins/images/users/varun.jpg")?> alt="user-img" width="36"
                                    class="img-circle"><span class="text-white font-medium"><?= $this->session->userdata('username') ?></span></a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('bahan/index') ?>"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('transaksi/index') ?>"
                                aria-expanded="false">
						...
						<?php  } ?>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('transaksi/laporan') ?>"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('peramalan/index') ?>"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('user/logout') ?>"
                                aria-expanded="false">
